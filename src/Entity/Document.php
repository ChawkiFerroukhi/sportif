 ...
 * Document
 *
 * @ORM\Table(name="Document", indexes={@ORM\Index(name="dossiermedicalId", columns={"dossiermedicalId"}) })
 * @ORM\Entity
 * @Vich\Uploadable
 */
class Document implements \Serializable
{
    ...
    */
     ...
     * @ORM\JoinColumns({
     *   @ORM\JoinColumn(name="dossiermedicalid", referencedColumnName="id" , onDelete="CASCADE")
     * })
     */
