 ...
 */
final class Version20230302100916 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE Adherant (id INT AUTO_INCREMENT NOT NULL, createdAt DATETIME  NOT NULL, updatedAt DATETIME NOT NULL, nom VARCHAR(191) NOT NULL, prenom VARCHAR(191) NOT NULL, birthDate DATETIME NOT NULL, birthPlace VARCHAR(191) NOT NULL, niveau_scolaire VARCHAR(191) NOT NULL, ecole VARCHAR(191) NOT NULL, num_tel VARCHAR(191) NOT NULL, licence VARCHAR(191) NOT NULL, sexe VARCHAR(191) NOT NULL, maladie VARCHAR(191) NOT NULL, dossier_medicalId INT DEFAULT NULL, categrieId INT DEFAULT NULL, equipeId INT DEFAULT NULL, Deme_categorieId INT DEFAULT NULL, clubId INT DEFAULT NULL, supervisorId INT DEFAULT NULL, INDEX equipeId (equipeId), INDEX categrieId (categrieId), INDEX clubId (clubId), INDEX Deme_categorieId (Deme_categorieId), INDEX supervisorId (supervisorId), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE Administrateur (id INT AUTO_INCREMENT NOT NULL, createdAt DATETIME  NOT NULL, updatedAt DATETIME NOT NULL, nom VARCHAR(191) NOT NULL, prenom VARCHAR(191) NOT NULL, num_tel VARCHAR(191) NOT NULL, CIN VARCHAR(191) NOT NULL, adresse VARCHAR(191) NOT NULL, clubId INT DEFAULT NULL, INDEX clubId (clubId), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE Categorie (id INT AUTO_INCREMENT NOT NULL, createdAt DATETIME  NOT NULL, updatedAt DATETIME NOT NULL, nom VARCHAR(191) NOT NULL, clubId INT DEFAULT NULL, INDEX clubId (clubId), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE Club (id INT AUTO_INCREMENT NOT NULL, createdAt DATETIME  NOT NULL, updatedAt DATETIME NOT NULL, nom VARCHAR(191) NOT NULL, adresse VARCHAR(191) NOT NULL, num_tel VARCHAR(191) NOT NULL, date_fondation DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE Coach (id INT AUTO_INCREMENT NOT NULL, createdAt DATETIME  NOT NULL, updatedAt DATETIME NOT NULL, nom VARCHAR(191) NOT NULL, prenom VARCHAR(191) NOT NULL, num_tel VARCHAR(191) NOT NULL, CIN VARCHAR(191) NOT NULL, adresse VARCHAR(191) NOT NULL, clubId INT DEFAULT NULL, INDEX clubId (clubId), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE Cours (id INT AUTO_INCREMENT NOT NULL, createdAt DATETIME  NOT NULL, updatedAt DATETIME NOT NULL, nom VARCHAR(191) NOT NULL, clubId INT DEFAULT NULL, niveauId INT DEFAULT NULL, INDEX niveauId (niveauId), INDEX clubId (clubId), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE Cycle (id INT AUTO_INCREMENT NOT NULL, createdAt DATETIME  NOT NULL, updatedAt DATETIME NOT NULL, nom VARCHAR(191) NOT NULL, coursId INT DEFAULT NULL, clubId INT DEFAULT NULL, INDEX coursId (coursId), INDEX clubId (clubId), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE DemeCategorie (id INT AUTO_INCREMENT NOT NULL, createdAt DATETIME  NOT NULL, updatedAt DATETIME NOT NULL, nom VARCHAR(191) NOT NULL, clubId INT DEFAULT NULL, INDEX clubId (clubId), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE Doctor (id INT AUTO_INCREMENT NOT NULL, createdAt DATETIME  NOT NULL, updatedAt DATETIME NOT NULL, nom VARCHAR(191) NOT NULL, prenom VARCHAR(191) NOT NULL, num_tel VARCHAR(191) NOT NULL, CIN VARCHAR(191) NOT NULL, adresse VARCHAR(191) NOT NULL, clubId INT DEFAULT NULL, INDEX clubId (clubId), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE DossierMedical (id INT AUTO_INCREMENT NOT NULL, createdAt DATETIME  NOT NULL, updatedAt DATETIME NOT NULL, clubId INT DEFAULT NULL, adherantId INT DEFAULT NULL, INDEX clubId (clubId), UNIQUE INDEX DossierMedical_adherantId_unique (adherantId), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE Equipe (id INT AUTO_INCREMENT NOT NULL, createdAt DATETIME  NOT NULL, updatedAt DATETIME NOT NULL, nom VARCHAR(191) NOT NULL, niveauId INT DEFAULT NULL, doctorId INT DEFAULT NULL, clubId INT DEFAULT NULL, coachId INT DEFAULT NULL, INDEX niveauId (niveauId), INDEX clubId (clubId), INDEX doctorId (doctorId), INDEX coachId (coachId), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE Master (id INT AUTO_INCREMENT NOT NULL, createdAt DATETIME  NOT NULL, updatedAt DATETIME NOT NULL, nom VARCHAR(191) NOT NULL, prenom VARCHAR(191) NOT NULL, num_tel VARCHAR(191) NOT NULL, CIN VARCHAR(191) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE Mesure (id INT AUTO_INCREMENT NOT NULL, createdAt DATETIME  NOT NULL, updatedAt DATETIME NOT NULL, date DATETIME NOT NULL, poids DOUBLE PRECISION NOT NULL, taille DOUBLE PRECISION NOT NULL, poitrine DOUBLE PRECISION NOT NULL, cuisse DOUBLE PRECISION NOT NULL, biceps DOUBLE PRECISION NOT NULL, age INT NOT NULL, imc DOUBLE PRECISION NOT NULL, diagnostic VARCHAR(191) NOT NULL, doctorId INT DEFAULT NULL, clubId INT DEFAULT NULL, dossier_medicalId INT DEFAULT NULL, INDEX dossier_medicalId (dossier_medicalId), INDEX doctorId (doctorId), INDEX clubId (clubId), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE Niveau (id INT AUTO_INCREMENT NOT NULL, createdAt DATETIME  NOT NULL, updatedAt DATETIME NOT NULL, nom VARCHAR(191) NOT NULL, clubId INT DEFAULT NULL, sectionId INT DEFAULT NULL, INDEX sectionId (sectionId), INDEX clubId (clubId), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE Note (id INT AUTO_INCREMENT NOT NULL, createdAt DATETIME  NOT NULL, updatedAt DATETIME NOT NULL, note DOUBLE PRECISION NOT NULL, objectifId INT DEFAULT NULL, testeId INT DEFAULT NULL, clubId INT DEFAULT NULL, adherantId INT DEFAULT NULL, INDEX objectifId (objectifId), INDEX clubId (clubId), INDEX testeId (testeId), INDEX adherantId (adherantId), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE Objectif (id INT AUTO_INCREMENT NOT NULL, createdAt DATETIME  NOT NULL, updatedAt DATETIME NOT NULL, nom VARCHAR(191) NOT NULL, cycleId INT DEFAULT NULL, clubId INT DEFAULT NULL, INDEX cycleId (cycleId), INDEX clubId (clubId), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE Seance (id INT AUTO_INCREMENT NOT NULL, createdAt DATETIME  NOT NULL, updatedAt DATETIME NOT NULL, date DATETIME NOT NULL, equipeId INT DEFAULT NULL, cycleId INT DEFAULT NULL, clubId INT DEFAULT NULL, INDEX clubId (clubId), INDEX equipeId (equipeId), INDEX cycleId (cycleId), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE Section (id INT AUTO_INCREMENT NOT NULL, createdAt DATETIME  NOT NULL, updatedAt DATETIME NOT NULL, nom VARCHAR(191) NOT NULL, clubId INT DEFAULT NULL, INDEX clubId (clubId), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE Teste (id INT AUTO_INCREMENT NOT NULL, createdAt DATETIME  NOT NULL, updatedAt DATETIME NOT NULL, date DATETIME NOT NULL, nom VARCHAR(191) NOT NULL, equipeId INT DEFAULT NULL, clubId INT DEFAULT NULL, INDEX equipeId (equipeId), INDEX clubId (clubId), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
