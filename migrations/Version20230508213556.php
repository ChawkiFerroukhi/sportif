...
final class Version20230508213556 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE Blog (id INT AUTO_INCREMENT NOT NULL, createdAt DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, updatedAt DATETIME NOT NULL, title VARCHAR(191) NOT NULL, content VARCHAR(5000) NOT NULL, cover VARCHAR(255) NOT NULL, clubId INT DEFAULT NULL, INDEX IDX_6027FE7D1FB658F6 (clubId), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
