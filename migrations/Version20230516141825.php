 ...
 */
final class Version20230516141825 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE Blog (id INT AUTO_INCREMENT NOT NULL, createdAt DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, updatedAt DATETIME NOT NULL, title VARCHAR(191) NOT NULL, content VARCHAR(191) NOT NULL, cover VARCHAR(255) NOT NULL, is_visible TINYINT(1) NOT NULL, video VARCHAR(191) DEFAULT NULL, clubId INT DEFAULT NULL, sectionId INT DEFAULT NULL, INDEX IDX_6027FE7D1FB658F6 (clubId), INDEX IDX_6027FE7D438B1980 (sectionId), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE Cours (id INT AUTO_INCREMENT NOT NULL, createdAt DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, updatedAt DATETIME NOT NULL, nom VARCHAR(191) NOT NULL, description VARCHAR(555) NOT NULL, clubId INT DEFAULT NULL, niveauId INT DEFAULT NULL, INDEX niveauId (niveauId), INDEX clubId (clubId), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE Cycle (id INT AUTO_INCREMENT NOT NULL, createdAt DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, updatedAt DATETIME NOT NULL, nom VARCHAR(191) NOT NULL, description VARCHAR(555) NOT NULL, startDate DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, endDate DATETIME NOT NULL, coursId INT DEFAULT NULL, clubId INT DEFAULT NULL, INDEX coursId (coursId), INDEX clubId (clubId), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE Niveau (id INT AUTO_INCREMENT NOT NULL, createdAt DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, updatedAt DATETIME NOT NULL, nom VARCHAR(191) NOT NULL, description VARCHAR(555) NOT NULL, clubId INT DEFAULT NULL, sectionId INT DEFAULT NULL, INDEX sectionId (sectionId), INDEX clubId (clubId), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE Note (id INT AUTO_INCREMENT NOT NULL, createdAt DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, updatedAt DATETIME NOT NULL, note DOUBLE PRECISION NOT NULL, observation VARCHAR(555) NOT NULL, objectifId INT DEFAULT NULL, testeId INT DEFAULT NULL, clubId INT DEFAULT NULL, adherantId INT DEFAULT NULL, INDEX objectifId (objectifId), INDEX clubId (clubId), INDEX testeId (testeId), INDEX adherantId (adherantId), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE Objectif (id INT AUTO_INCREMENT NOT NULL, createdAt DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, updatedAt DATETIME NOT NULL, nom VARCHAR(191) NOT NULL, description VARCHAR(555) NOT NULL, cycleId INT DEFAULT NULL, clubId INT DEFAULT NULL, INDEX cycleId (cycleId), INDEX clubId (clubId), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE Payment (id INT AUTO_INCREMENT NOT NULL, adherantid INT DEFAULT NULL, createdAt DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, updatedAt DATETIME NOT NULL, date DATETIME NOT NULL, total DOUBLE PRECISION NOT NULL, mode VARCHAR(191) NOT NULL, status VARCHAR(191) NOT NULL, designation VARCHAR(191) NOT NULL, ref VARCHAR(191) NOT NULL, clubId INT DEFAULT NULL, INDEX IDX_A295BD9192F9C8F8 (adherantid), INDEX clubId (clubId), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE Seance (id INT AUTO_INCREMENT NOT NULL, createdAt DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, updatedAt DATETIME NOT NULL, date DATETIME NOT NULL, description VARCHAR(555) NOT NULL, equipeId INT DEFAULT NULL, cycleId INT DEFAULT NULL, clubId INT DEFAULT NULL, INDEX clubId (clubId), INDEX equipeId (equipeId), INDEX cycleId (cycleId), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE Section (id INT AUTO_INCREMENT NOT NULL, createdAt DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, updatedAt DATETIME NOT NULL, nom VARCHAR(191) NOT NULL, description VARCHAR(555) NOT NULL, clubId INT DEFAULT NULL, INDEX clubId (clubId), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE Supervisor (id INT NOT NULL, createdAt DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, updatedAt DATETIME NOT NULL, nom VARCHAR(191) NOT NULL, prenom VARCHAR(191) NOT NULL, num_tel VARCHAR(191) NOT NULL, CIN VARCHAR(191) NOT NULL, adresse VARCHAR(191) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE Teste (id INT AUTO_INCREMENT NOT NULL, createdAt DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, updatedAt DATETIME NOT NULL, date DATETIME NOT NULL, nom VARCHAR(191) NOT NULL, description VARCHAR(555) NOT NULL, equipeId INT DEFAULT NULL, cycleId INT DEFAULT NULL, clubId INT DEFAULT NULL, INDEX IDX_2775660B8105C8EF (cycleId), INDEX equipeId (equipeId), INDEX clubId (clubId), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
