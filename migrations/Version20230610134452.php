 ...
 */
final class Version20230610134452 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE Adherant (id INT AUTO_INCREMENT NOT NULL, createdAt DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, updatedAt DATETIME NOT NULL, nom VARCHAR(191) NOT NULL, prenom VARCHAR(191) NOT NULL, birthDate DATE NOT NULL, birthPlace VARCHAR(191) NOT NULL, niveau_scolaire VARCHAR(191) NOT NULL, ecole VARCHAR(191) NOT NULL, num_tel VARCHAR(191) NOT NULL, licence VARCHAR(191) NOT NULL, sexe VARCHAR(191) NOT NULL, maladie VARCHAR(191) NOT NULL, ref VARCHAR(255) NOT NULL, picture VARCHAR(255) NOT NULL, dossier_medicalId INT DEFAULT NULL, equipeId INT DEFAULT NULL, clubId INT DEFAULT NULL, supervisorId INT DEFAULT NULL, INDEX IDX_6EAC3AEA3AC4B029 (dossier_medicalId), INDEX IDX_6EAC3AEA1FB658F6 (clubId), INDEX equipeId (equipeId), INDEX supervisorId (supervisorId), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE Cours (id INT AUTO_INCREMENT NOT NULL, createdAt DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, updatedAt DATETIME NOT NULL, nom VARCHAR(191) NOT NULL, description VARCHAR(5000) NOT NULL, clubId INT DEFAULT NULL, niveauId INT DEFAULT NULL, INDEX niveauId (niveauId), INDEX clubId (clubId), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE Cycle (id INT AUTO_INCREMENT NOT NULL, createdAt DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, updatedAt DATETIME NOT NULL, nom VARCHAR(191) NOT NULL, description VARCHAR(5000) NOT NULL, startDate DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, endDate DATETIME NOT NULL, coursId INT DEFAULT NULL, clubId INT DEFAULT NULL, INDEX coursId (coursId), INDEX clubId (clubId), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE Niveau (id INT AUTO_INCREMENT NOT NULL, createdAt DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, updatedAt DATETIME NOT NULL, nom VARCHAR(191) NOT NULL, description VARCHAR(5000) NOT NULL, clubId INT DEFAULT NULL, sectionId INT DEFAULT NULL, INDEX sectionId (sectionId), INDEX clubId (clubId), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE Adherant ADD CONSTRAINT FK_6EAC3AEA1FB658F6 FOREIGN KEY (clubId) REFERENCES Club (id) ON DELETE CASCADE');
