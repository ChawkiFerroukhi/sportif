 ...
 */
final class Version20230315153800 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE Adherant CHANGE createdAt createdAt DATETIME DEFAULT \'current_timestamp(3)\' NOT NULL, CHANGE maladie maladie VARCHAR(191) NOT NULL');
        ...
        $this->addSql('ALTER TABLE Administrateur CHANGE createdAt createdAt DATETIME DEFAULT \'current_timestamp(3)\' NOT NULL');
        $this->addSql('ALTER TABLE Categorie CHANGE createdAt createdAt DATETIME DEFAULT \'current_timestamp(3)\' NOT NULL');
        $this->addSql('ALTER TABLE Club CHANGE createdAt createdAt DATETIME DEFAULT \'current_timestamp(3)\' NOT NULL');
        $this->addSql('ALTER TABLE Coach CHANGE createdAt createdAt DATETIME DEFAULT \'current_timestamp(3)\' NOT NULL');
        $this->addSql('ALTER TABLE Cours CHANGE createdAt createdAt DATETIME DEFAULT \'current_timestamp(3)\' NOT NULL');
        $this->addSql('ALTER TABLE Cycle CHANGE createdAt createdAt DATETIME DEFAULT \'current_timestamp(3)\' NOT NULL');
        $this->addSql('ALTER TABLE DemeCategorie CHANGE createdAt createdAt DATETIME DEFAULT \'current_timestamp(3)\' NOT NULL');
        $this->addSql('ALTER TABLE Doctor CHANGE createdAt createdAt DATETIME DEFAULT \'current_timestamp(3)\' NOT NULL');
        $this->addSql('ALTER TABLE DossierMedical CHANGE createdAt createdAt DATETIME DEFAULT \'current_timestamp(3)\' NOT NULL');
        $this->addSql('ALTER TABLE Equipe CHANGE createdAt createdAt DATETIME DEFAULT \'current_timestamp(3)\' NOT NULL');
        $this->addSql('ALTER TABLE Master CHANGE createdAt createdAt DATETIME DEFAULT \'current_timestamp(3)\' NOT NULL');
        $this->addSql('ALTER TABLE Mesure CHANGE createdAt createdAt DATETIME DEFAULT \'current_timestamp(3)\' NOT NULL');
        $this->addSql('ALTER TABLE Niveau CHANGE createdAt createdAt DATETIME DEFAULT \'current_timestamp(3)\' NOT NULL');
        $this->addSql('ALTER TABLE Note CHANGE createdAt createdAt DATETIME DEFAULT \'current_timestamp(3)\' NOT NULL');
        $this->addSql('ALTER TABLE Objectif CHANGE createdAt createdAt DATETIME DEFAULT \'current_timestamp(3)\' NOT NULL');
        $this->addSql('ALTER TABLE Seance CHANGE createdAt createdAt DATETIME DEFAULT \'current_timestamp(3)\' NOT NULL');
        $this->addSql('ALTER TABLE Section CHANGE createdAt createdAt DATETIME DEFAULT \'current_timestamp(3)\' NOT NULL');
        $this->addSql('ALTER TABLE Supervisor CHANGE createdAt createdAt DATETIME DEFAULT \'current_timestamp(3)\' NOT NULL');
        $this->addSql('ALTER TABLE Teste CHANGE createdAt createdAt DATETIME DEFAULT \'current_timestamp(3)\' NOT NULL');
    }
